...
/*
ßßßßßßßßßßßßßßßßßßßßßßßßßßß {Protheus.doc} ZMVC29 ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
ßß   Exemplo de importacao de dados para uma estrutura de pai/filho                   ßß
...
User Function ZMVC29()
	...
	If nOpc == 1
		...
		If lOk
			FWAlertInfo( 'Processamento terminado com sucesso.', 'ATENÇÃO' )
		Else
			FWAlertError( 'Processamento realizado com problemas.', 'ATENÇÃO' )
		EndIf
...
Static Function Import( cMaster, cDetail, aCpoMaster, aCpoDetail )
	...
	If lRet
		...
		For nI := 1 To Len( aCpoDetail )
			...
			// ATENCAO: O itens são criados em uma estrura de grid (FORMGRID), portanto já é criada uma primeira
			// linha em branco automaticamente, desta forma começamos a inserir novas linhas a partir da 2ª vez
