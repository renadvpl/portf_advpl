...
%%    @Desc:   Geração de PDF com FWMSPrinter (impressão de textos c/ Say e SayBitmap) %%
%%    @Func:   PDF001                                                                  %%
%%    @Author: Renato Silva                                                            %%
%%    @Since:  28/11/2022                                                              %%
...
Static Function fMontaRel()
    ...
    oPrintPvt:StartPage()
        ...
        oPrintPvt:SayBitmap(nLinAtu + 50, nColIni + 25, cLogoRel, 130, 78) // 100 é a metade de 200, - 35 que é a metade da largura, dá 065
